        ...
        <div className="card-body">
          ...
          <div className="d-flex justify-content-center mb-3">
            <div className="d-flex align-items-center gap-2 flex-nowrap">
              ...
              <button className="btn btn-sm btn-outline-primary" onClick={() => { setSelectedYear("2025"); setViewMode("monthly"); setSelectedColumn("Video Output (Kw)"); }} title="Reset filter" style={{ whiteSpace: "nowrap" }}>
          ...
          <ResponsiveContainer width="100%" height={315}>
            <BarChart data={chartData}>
              ...
              <Bar dataKey="value" fill="#539bff" barSize={30} radius={[6, 6, 0, 0]} animationDuration={800}>
