...
export default function CardChartchanneltvri({ data }) {
  ...
  const columnOptions = ["TVRI SUMSEL", "TVRI NASIONAL", "TVRI SPORT", "TVRI WORLD"];
            ...
            <LineChart data={chartData}>
              ...
              <Line
                ...
                dot={(props) => {
                  ...
                  const warna = payload.nilaiRata > 4 ? "red" : "#539bff";
                  return (
                    <circle
                      cx={cx}
                      cy={cy}
